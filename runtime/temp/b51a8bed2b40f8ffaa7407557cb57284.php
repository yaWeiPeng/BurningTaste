<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods/brandList.html";i:1540260088;s:62:"/var/www/html/tpshop/application/admin/view/public/layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
              ...
              <tr data-id="<?php echo $list[id]; ?>">
                ...
                <td align="left" class="">
                  <div style="text-align: left; width: 100px;">
	                  <a href="<?php echo !empty($list['logo'])?$list['logo']:'/public/images/icon_goods_thumb_empty_300.png'; ?>" target="_blank"><img onMouseOver="$(this).attr('width','80').attr('height','45');" onMouseOut="$(this).attr('width','40').attr('height','30');" width="40" height="30" src="<?php echo !empty($list['logo'])?$list['logo']:'/public/images/icon_goods_thumb_empty_300.png'; ?>"/></a>
                  </div>
                </td>
